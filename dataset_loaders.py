...
class LatentHatredDataset(Dataset):
    """
    Enhanced dataset with proper three-way stratified split (60/20/20)
    """
    def __init__(self, path, split="train", train_ratio=0.6, val_ratio=0.20, test_ratio=0.20, random_state=42):
        """
        Args:
