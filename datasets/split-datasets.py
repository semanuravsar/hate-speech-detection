...
df_hatred = pd.read_csv("datasets/latent_hatred_3class.csv")
train_h, test_h = train_test_split(df_hatred, test_size=0.2, random_state=42, stratify=df_hatred["label_id"])
train_h.to_csv("datasets/latent_hatred_3class_train.csv", index=False)
test_h.to_csv("datasets/latent_hatred_3class_test.csv", index=False)
