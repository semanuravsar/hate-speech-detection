...
def run_grid_search():
    ...
    for lr, dropout, mw, aw, aux_config in itertools.product(
        ...
        if aw_stereo > 0:
            ...
            test_stereo = StereoSetDataset("datasets/stereoset_test.csv")
        ...
        if aw_sarcasm > 0:
            ...
            test_sarcasm = ISarcasmDataset("datasets/isarcasm_test.csv")
        ...
        if aw_fine > 0:
            ...
            test_fine = ImplicitFineHateDataset("datasets/implicit_fine_labels_test.csv")
